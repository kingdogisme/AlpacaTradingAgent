...
from tradingagents.agents.utils.tool_quality import (
    TOOL_MIN_OUTPUT_CHARS,
    _build_timeout_fallback,
    _maybe_prepend_data_quality_header as _tool_quality_prepend_header,
    _merge_quality_details,
...
def _maybe_prepend_data_quality_header(result: object, data_quality: dict) -> str:
    return _tool_quality_prepend_header(result, data_quality, Toolkit._config)
